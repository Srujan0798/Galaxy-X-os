...
3. Watch the prediction card appear: "Spiral Galaxy -- 94.2% confidence"
4. Show the probability distribution bar chart
5. Scroll down to reveal the Grad-CAM overlay

**Narration**:
"Our interactive web demo allows users to upload any astronomical image and instantly get a classification prediction with confidence scores. The model correctly identifies this as a Spiral Galaxy with 94% confidence. Below, the Grad-CAM heatmap shows exactly which regions the model focused on -- the spiral arms and central bulge."
...
**Narration**:
"Our inference engine processes images in under 15 milliseconds on GPU. Here's a batch of 16 test images classified in real-time."
...
**Narration**:
"On the test set, our model achieves 91% accuracy with standard evaluation and 93% with test-time augmentation. All 5 classes show strong F1 scores above 0.85."
