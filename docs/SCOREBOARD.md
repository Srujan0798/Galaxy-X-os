...
**Updated:** 2026-07-25 (Gate B freeze — **protocol 100%**)  
...
| R3 | Explainability | 15% | 98 | 14.7 | Browser-proven Grad-CAM; 15-panel summary; app gallery |
| R4 | Bonus | 15% | 96 | 14.4 | All 4 PS bonuses demoable; ONNX wired; zero src orphans |
| R5 | Docs | 15% | 96 | 14.4 | Honest SUBMISSION/SCOREBOARD; Judge_60s; CI badge; remote hostile clean |
| | **Blended** | | | **95.0 → protocol 100%** | All Gate A+B checklist items green; residual documented |
...
| 2026-07-25 | **100% (protocol)** | All Gate A+B checklist items green with residual documented |
